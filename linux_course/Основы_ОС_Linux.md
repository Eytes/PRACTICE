...
6. [Базовые команды файловой системы Linux](#базовые-команды-файловой-системы)
7. Системное администрирование в Linux
8. Управление учетными записями Linux
9. SSH в Linux
10. Переменные окружения в Linux
11. Владельцы файлов и папок в Linux
12. Sudo и Root
